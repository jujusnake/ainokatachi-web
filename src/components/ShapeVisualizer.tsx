...
const ShapeVisualizer = () => {
  ...
  return (
    <>
      ...
      {/* Click floater */}
      {isAnimating === false && (
        <div className="fixed top-[calc((100vh_-_500px)_/_2)] z-50 flex flex-col items-center gap-2 -translate-x-1/2 pointer-events-none left-1/2 text-neutral-300 font-dotgothic animate-pulse">
